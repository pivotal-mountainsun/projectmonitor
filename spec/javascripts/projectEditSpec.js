  ...
  describe("Feed URL fields", function() {
    beforeEach(function() {
      setFixtures('' +
        ...
        '    <p>' +
        '      <label for="project_cruise_control_rss_feed_url"><span class="translation_missing" title="translation missing: en.projects.cruise_control_rss_feed_url">Cruise Control Rss Feed Url</span></label>' +
        '      <input id="project_cruise_control_rss_feed_url" name="project[cruise_control_rss_feed_url]" size="30" type="text" />' +
        '    </p>' +
        '  </fieldset>' +
        '  <fieldset class="hide" id="JenkinsProject">' +
        '    <p>' +
        '      <label for="project_jenkins_base_url">Base URL</label>' +
        '      <input id="project_jenkins_base_url" name="project[jenkins_base_url]" size="30" type="text" />' +
        '    </p>' +
        '  </fieldset>' +
        '</div>');
      ProjectEdit.init();
